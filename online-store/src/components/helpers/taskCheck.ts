console.log(`Online store task`);
console.log(`Самооценка (85/200):`);
console.log(`
Пункты задания.
✔️ 1. Страница с товарами содержит карточки всех товаров а также фильтры по значению (5/10)
